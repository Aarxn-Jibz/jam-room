...
const WEEK_MONDAY = Date.UTC(2026, 7, 9, 18, 30); // Monday 2026-08-10 00:00 IST
...
describe('buildWeeklyGrid', () => {
  ...
  it('places APPROVED bookings in the correct room/day/time cell', async () => {
    await addBooking(
      ...
      'room-main',
      'profile-choir',
      Date.UTC(2026, 7, 10, 3, 30), // Monday 09:00 IST
      'APPROVED',
    );
    await addBooking(
      db,
      ...
      'room-acoustic',
      'profile-choir',
      Date.UTC(2026, 7, 11, 3, 30), // Tuesday 09:00 IST
      'APPROVED',
    );
    await addBooking(
      db,
      ...
      'room-acoustic',
      'profile-choir',
      Date.UTC(2026, 7, 16, 3, 30), // Sunday 09:00 IST
      'APPROVED',
    );
  ...
  it('excludes bookings outside the target week', async () => {
    await addBooking(
      ...
      'room-main',
      'profile-choir',
      Date.UTC(2026, 7, 17, 3, 30), // Monday of the NEXT week, IST
      'APPROVED',
    );
    await addBooking(
      db,
      ...
      'room-main',
      'profile-choir',
      Date.UTC(2026, 7, 9, 3, 30), // Sunday of the PREVIOUS week, IST
      'APPROVED',
    );
