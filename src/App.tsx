  ...
  return <div className="app">
    ...
    <main>{page === 'booking' ? <section className="booking-page">
      ...
      <section className="schedule-card">
        ...
        <div className="mobile-days">{days.map((day, index) => <button key={day.toISOString()} className={mobileDay === index ? 'selected' : ''} onClick={() => setMobileDay(index)}><span>{day.toLocaleDateString('en-IN', { weekday: 'short' })}</span>{day.getDate()}</button>)}</div>
